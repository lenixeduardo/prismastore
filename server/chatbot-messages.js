export const DEFAULT_CHATBOT_MESSAGES = Object.freeze({
  ...
  addressInputPrompt: 'Envie seu endereço com *rua, número e bairro*. Complemento, cidade/UF e CEP podem ser incluídos na mesma mensagem.',
  addressStreetPrompt: 'Faltou o *nome da rua*. Qual é a rua do endereço?',
  addressNumberPrompt: 'Faltou o *número*. Qual é o número do endereço?',
  addressNeighborhoodPrompt: 'Faltou o *bairro*. Qual é o bairro do endereço?',
