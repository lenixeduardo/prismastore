const CACHE_NAME = 'prismastore-shell-v0.9.2-admin-qr-1';
const CACHE_PREFIX = 'prismastore-shell-';
const APP_SHELL = [
  '/', '/index.html', '/manifest.webmanifest',
  '/src/styles.css', '/src/reports.css', '/src/backup.css', '/src/pwa.css', '/src/hero.css', '/src/admin-extensions.css', '/src/admin-shell-fixes.css',
  ...
  '/src/admin-extensions.js', '/src/product-editor.js', '/src/chatbot-settings.js', '/src/chat-simulator.js', '/src/admin-icons.js', '/src/whatsapp-onboarding.js',
