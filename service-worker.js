const CACHE_NAME = 'prismastore-shell-v0.9.2-mobile-security-1';
const CACHE_PREFIX = 'prismastore-shell-';
const APP_SHELL = [
  '/', '/index.html', '/manifest.webmanifest',
  '/src/styles.css', '/src/reports.css', '/src/backup.css', '/src/pwa.css', '/src/hero.css', '/src/auth-gate.css', '/src/admin-extensions.css', '/src/admin-shell-fixes.css', '/src/orders-board.css',
  '/src/app.js', '/src/data.js', '/src/domain.js', '/src/live-sync.js', '/src/payment-status.js',
  '/src/order-lifecycle-ui.js', '/src/reports-ui.js', '/src/backup-ui.js', '/src/pwa.js', '/src/auth-gate.js', '/src/hero.js',
